...
#define LED_PIN 2             // which pin are LEDS connected to?
#define NUM_LEDS 7
...
const int colourInPin = A0;      // The Analog input pin that the colour control potentiometer is attached to.
...
void loop() {
  ...
  int mappedValue = map(analogRead(brightnessInPin), 0, 1024, 0, 255);
